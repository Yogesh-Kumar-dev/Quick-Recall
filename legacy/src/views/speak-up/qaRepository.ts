...
// The ONLY module that touches persistence (Dexie / IndexedDB via the shared `db`)
// for Speak Up Q&As. All methods are async-shaped on purpose: to migrate to an HTTP /
// server backend later, replace the body of these four functions only — every
// consumer (useSpeakUpQAs, the drawer, the cards) stays untouched.
