'use client';
/**
 * DEBOUNCED SEARCH — PLAIN HTML VERSION
 * ──────────────────────────────────────────────────────────────────────────────
 * Zero MUI. Same useDebounce hook + search logic. Pure HTML + inline styles.
 */
...
// ── useDebounce hook (identical to MUI version) ────────────────────────────────
...
export default function DebouncedSearch() {
  ...
  const debouncedQuery: string = useDebounce(query, 400);
  const isTyping: boolean = query !== debouncedQuery;
