'use client';
/**
 * SORTABLE TABLE — TYPESCRIPT VERSION
 * ──────────────────────────────────────────────────────────────────────────────
 * Same logic as the JSX version, fully typed. The sort state is { key, dir };
 * the sorted rows are derived via useMemo from (data, sort). A union of the
 * sortable keys keeps `sort.key` honest, and `dir` is 'asc' | 'desc'.
 */
...
const cell: CSSProperties = { padding: '8px 12px', borderBottom: '1px solid #eef0f3', textAlign: 'left' };
