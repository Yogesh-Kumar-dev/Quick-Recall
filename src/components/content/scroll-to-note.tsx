...
// delay covers the virtualized list case, where the virtualizer needs a tick to mount the item
// that `scrollToIndex` scrolled to before it exists in the DOM for getElementById to find.
