...
// Reads its own bookmarked state via a single-row live query rather than the full bookmark list —
// a page can render many of these, and each subscribing to the whole list would be wasteful.
// Bookmarking a flashcard also auto-enrolls it in the SRS deck.

interface BookmarkButtonProps {
  kind: BookmarkKind;
  refId: string;
  // needed when the card header is itself clickable (e.g. LeafyGreen ExpandableCard) so
  // toggling a bookmark doesn't also expand it
