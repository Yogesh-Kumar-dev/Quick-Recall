...
const sampleCards: Flashcard[] = [
  ...
  { id: '3', front: 'What is the event loop?', back: 'The mechanism that handles async callbacks by checking the call stack and task queue.' },
  { id: '4', front: 'What is `===` vs `==`?', back: 'Strict equality checks type + value; loose equality performs type coercion first.' },
  { id: '5', front: 'What is hoisting?', back: 'Variable and function declarations are moved to the top of their scope during compilation.' }
]
