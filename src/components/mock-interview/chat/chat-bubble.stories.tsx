...
export const UserMessage: Story = {
  args: {
    from: 'user',
    children:
      'In my previous role, we had a memory leak in production that was causing crashes during peak hours. I used Chrome DevTools memory profiler to identify the leak...'
  }
};
