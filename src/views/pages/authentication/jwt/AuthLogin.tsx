...
export default function JWTLogin({ ...others }) {
  ...
  const {
    ...
    defaultValues: { email: 'info@codedthemes.com', password: '123456' }
  });
      ...
      <Grid container sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Grid>
          <Typography
            ...
            component={Link}
            href={
              isLoggedIn ? '/pages/forgot-password/forgot-password3' : authParam ? `/forgot-password?auth=${authParam}` : '/forgot-password'
            }
            color="secondary"
