'use client';
/**
 * FILE TREE EXPLORER — PLAIN HTML VERSION
 * ──────────────────────────────────────────────────────────────────────────────
 * Zero MUI. Same recursive helpers + useReducer. Plain div + inline styles.
 * The logic (treeReducer, toggleNode, addNode, deleteNode) is identical to
 * the MUI version — only the JSX rendering differs.
 */
...
// ── Recursive component ────────────────────────────────────────────────────────
function Node({ node, depth, dispatch }: { node: TreeNode; depth: number; dispatch: React.Dispatch<Action> }) {
