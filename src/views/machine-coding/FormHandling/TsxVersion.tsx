'use client';
/**
 * FORM HANDLING — PLAIN HTML VERSION
 * ──────────────────────────────────────────────────────────────────────────────
 * Zero MUI. Controlled form with inline validation and submit feedback.
 *
 * Patterns:
 * - Single handleChange via e.target.name (no field-specific handlers)
 * - Validate-on-submit + clear error on field change
 * - Uncontrolled submit button (no loading state needed for this pattern)
 */
