'use client';
/**
 * MULTI-STEP FORM — JAVASCRIPT VERSION
 * ──────────────────────────────────────────────────────────────────────────────
...
const INITIAL_DATA = { firstName: '', lastName: '', email: '', phone: '', role: '', experience: '' };

const STEPS = [
  { title: 'Personal Info', subtitle: 'Tell us about yourself', validate: (d) => d.firstName.trim() && d.lastName.trim() },
  { title: 'Contact Details', subtitle: 'How can we reach you?', validate: (d) => d.email.trim() && d.phone.trim() },
  { title: 'Role & Experience', subtitle: "What's your background?", validate: (d) => d.role && d.experience },
    ...
    <div style={{ maxWidth: 440, padding: 24, border: '1px solid #e0e0e0', borderRadius: 10, background: '#fff' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ height: 8, background: '#e0e0e0', borderRadius: 4, overflow: 'hidden' }}>
          <div style={{ height: '100%', width: `${progress}%`, background: '#1976d2', borderRadius: 4, transition: 'width 0.3s ease' }} />
        </div>
